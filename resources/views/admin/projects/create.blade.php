                ...
                <div class="col-11">
                    ...
                    <form action="{{ route('admin.projects.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="programmingLanguages" name="programming_languages" value="{{ old('programming_languages') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="repoUrl" name="repo_url" value="{{ old('repo_url') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="creationDay" name="creation_day" value="{{ old('creation_day') }}">
